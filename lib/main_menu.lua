...
function main_menu.init()
  ...
  elseif menu == 6 then
    ...
    if focused_menu == 1 then
      ...
      screen.move(30,40)
      screen.text("fade: "..params:string("delay "..delay_name..": fade time"))
      screen.move(85,40)
      screen.text("rate: "..params:string("delay "..delay_name..": rate"))
      screen.level((page.delay_section == 3 and selected == 3) and 15 or 3)
      screen.move(30,50)
      screen.text("feedback: "..params:string("delay "..delay_name..": feedback"))
    ...
    elseif focused_menu == 3 then
      ...
      screen.move(50,30)
      screen.text("in: "..(page.delay_focus == 1 and bank[1][bank[1].id].left_delay_level or bank[1][bank[1].id].right_delay_level))
      screen.move(80,30)
      ...
      screen.move(50,40)
      screen.text("in: "..(page.delay_focus == 1 and bank[2][bank[2].id].left_delay_level or bank[2][bank[2].id].right_delay_level))
      screen.move(80,40)
      ...
      screen.move(50,50)
      screen.text("in: "..(page.delay_focus == 1 and bank[3][bank[3].id].left_delay_level or bank[3][bank[3].id].right_delay_level))
      screen.move(80,50)
